...
Running Apogeebrain
=================
The simplest way to run |apogeebrain| is with the command-line script ``apogeebrain``.  The only required argument is the name of a spectrum fits file.

.. code-block:: bash

    apogeebrain spectrum.fits
